...
export const SEO = () => {
    return (
        <Helmet>
            ...
            <meta property="description" content="This is my personal portfolio, here is my professional experience and my skills." />
            ...
            <meta name="description" property="og:description" content="This is my personal portfolio, here is my professional experience and my skills." />
